...
class SingUpController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    let alreadyHaveAccountButton: UIButton = {
        ...
        var attributedTitle = NSMutableAttributedString(string: "Already have an account?  ", attributes: [kCTFontAttributeName as NSAttributedStringKey: UIFont.systemFont(ofSize: 14)])
        
        
        attributedTitle.append(NSMutableAttributedString(string: "Sign In", attributes: [kCTFontAttributeName as NSAttributedStringKey: UIFont.boldSystemFont(ofSize: 15)]))
